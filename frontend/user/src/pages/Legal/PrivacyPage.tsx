...
export default function PrivacyPage() {
  ...
  return (
    <div className="min-h-screen px-4 py-12">
      ...
      >
        <div className="mb-6">
          <h1 className="font-heading text-3xl font-bold">{t('legal.privacy.title')}</h1>
          <p className="text-muted mt-1">{t('legal.privacy.subtitle')}</p>
          <p className="text-xs text-muted mt-2">{t('legal.privacy.updated_at')}</p>
        </div>
