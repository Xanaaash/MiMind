...
- [🔒 codex-0220i] **T-132** SCL-90 长量表分页答题 UX 优化（进度保存 + 分组标题）
- [✅] **T-133** 测试配对/互测功能（生成邀请链接 → 好友完成 → 匹配报告）
- [🔒 codex-0220b] **T-134** 量表定期重测提醒逻辑（对接后端 reassessment schedule）
...
- [🔒 cursor-0220h] **T-163** 语言切换后动态更新 `<html lang>`、`document.title`
