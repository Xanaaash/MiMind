...
- [ ] **T1.2 / T-803** 替换冥想播放列表并增加来源/版权元数据展示 - `frontend/user/src/config/meditationPlaylist.ts`, `frontend/user/src/pages/Tools/MeditationPlayer.tsx`
- [ ] **T1.3 / T-804** 升级心灵空间信息架构与显化双层交互（快速/深度） - `frontend/user/src/pages/Mindfulness/*`
